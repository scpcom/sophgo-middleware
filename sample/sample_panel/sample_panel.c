...
void SAMPLE_SET_PANEL_DESC(void)
{
	...
	case DSI_PANEL_ST7701_D300FPC9307A:
		g_panel_desc.panel_type = PANEL_MODE_DSI;
		g_panel_desc.stdsicfg.dev_cfg = &dev_cfg_st7701_480x854;
		g_panel_desc.stdsicfg.hs_timing_cfg = &hs_timing_cfg_st7701_480x854;
		g_panel_desc.stdsicfg.dsi_init_cmds = dsi_init_cmds_st7701_480x854;
		g_panel_desc.stdsicfg.dsi_init_cmds_size = ARRAY_SIZE(dsi_init_cmds_st7701_480x854);
		break;
	case DSI_PANEL_ST7701_D310T9362V1:
		g_panel_desc.panel_type = PANEL_MODE_DSI;
		g_panel_desc.stdsicfg.dev_cfg = &dev_cfg_st7701_d310t9362v1_480x800;
		g_panel_desc.stdsicfg.hs_timing_cfg = &hs_timing_cfg_st7701_d310t9362v1_480x800;
		g_panel_desc.stdsicfg.dsi_init_cmds = dsi_init_cmds_st7701_d310t9362v1_480x800;
		g_panel_desc.stdsicfg.dsi_init_cmds_size = ARRAY_SIZE(dsi_init_cmds_st7701_d310t9362v1_480x800);
		break;
	case DSI_PANEL_ST7701_DXQ5D0019B480854:
		g_panel_desc.panel_type = PANEL_MODE_DSI;
		g_panel_desc.stdsicfg.dev_cfg = &dev_cfg_st7701_480x854dxq;
		g_panel_desc.stdsicfg.hs_timing_cfg = &hs_timing_cfg_st7701_480x854dxq;
		g_panel_desc.stdsicfg.dsi_init_cmds = dsi_init_cmds_st7701_480x854dxq;
		g_panel_desc.stdsicfg.dsi_init_cmds_size = ARRAY_SIZE(dsi_init_cmds_st7701_480x854dxq);
		break;
	case DSI_PANEL_ST7701_DXQ5D0019_V0:
		g_panel_desc.panel_type = PANEL_MODE_DSI;
		g_panel_desc.stdsicfg.dev_cfg = &dev_cfg_st7701_480x854dxq_V0;
	...
	case DSI_PANEL_ST7701_LHCM228TS003A:
		g_panel_desc.panel_type = PANEL_MODE_DSI;
		g_panel_desc.stdsicfg.dev_cfg = &dev_cfg_st7701_368x552lhcm;
		g_panel_desc.stdsicfg.hs_timing_cfg = &hs_timing_cfg_st7701_368x552lhcm;
		g_panel_desc.stdsicfg.dsi_init_cmds = dsi_init_cmds_st7701_368x552lhcm;
		g_panel_desc.stdsicfg.dsi_init_cmds_size = ARRAY_SIZE(dsi_init_cmds_st7701_368x552lhcm);
		break;
	case DSI_PANEL_ZCT2133V1:
		g_panel_desc.panel_type = PANEL_MODE_DSI;
		g_panel_desc.stdsicfg.dev_cfg = &dev_cfg_zct2133v1_800x1280;
		g_panel_desc.stdsicfg.hs_timing_cfg = &hs_timing_cfg_zct2133v1_800x1280;
		g_panel_desc.stdsicfg.dsi_init_cmds = dsi_init_cmds_zct2133v1_800x1280;
		g_panel_desc.stdsicfg.dsi_init_cmds_size = ARRAY_SIZE(dsi_init_cmds_zct2133v1_800x1280);
		break;
	...
	case DSI_PANEL_HX8394_EVB:
		...
		break;
	case DSI_PANEL_MTD700920B:
		g_panel_desc.panel_type = PANEL_MODE_DSI;
		g_panel_desc.stdsicfg.dev_cfg = &dev_cfg_mtd700920b_800x1280;
		g_panel_desc.stdsicfg.hs_timing_cfg = &hs_timing_cfg_mtd700920b_800x1280;
		g_panel_desc.stdsicfg.dsi_init_cmds = dsi_init_cmds_mtd700920b_800x1280;
		g_panel_desc.stdsicfg.dsi_init_cmds_size = ARRAY_SIZE(dsi_init_cmds_mtd700920b_800x1280);
